            ...
            <article class="registration">
                ...
                <form action="create.php" method="post" class="registration-form">
                 ...
                 <div>
                     ...
                     <label for="book_code">書籍コード<sqan>【必須】</span></label>

                     <input type="number" id="book_code" name="book_code" min="0" max="10000" required>

 
                     <label for="book_name">書籍名<sqan>【必須】</span></label>

                     <input type="text" id="book_name" name="book_name" maxlength="100" required>

 
                     <label for="price">単価<sqan>【必須】</span></label>

                     <input type="number" id="price" name="price" min="0" max="9999" required>


                     <label for="stock_quantity">在庫数<sqan>【必須】</span></label>

                     <input type="number" id="stock_quantity" name="stock_quantity" min="0" max="100000000" required>

 

                     <label for="genre_code">ジャンルコード<sqan>【必須】</span></label>
